              ...
              return (
                <Formik
                  ...
                  validationSchema={Yup.object().shape({
                    ...
                    primaryEmail: Yup.lazy(value =>
                      !value || value === "" ? true : Yup.string().email()
                    ),
                    user: Yup.object({
                      email: Yup.string()
                        .email()
                  ...
                  onSubmit={(values, actions) => {
                    ...
                    createMerchant({
                      variables: {
                        ...
                        code: values.code,
                        unitThnxPrice: values.unitThnxPrice,
                        ...
                        passwordConfirmation: values.user.passwordConfirmation,
                        abn: values.abn,
                        bsb: values.bsb,
                      ...
                      .then(response => {
                        ...
                        if (createMerchant && createMerchant.accountId) {
                          props.handleCreate(createMerchant.accountId);
                          setShowSnack(true);
                      ...
                      >
                          ...
                          <div className={classes.nameContainer}>
                            ...
                            {values.id ? (
                              <TextField
                                ...
                                label="Default Price"
                                name="unitThnxPrice"
                                value={values.unitThnxPrice}
                                onChange={handleChange}
                                onBlur={handleBlur}
                                helperText={
                                  errors.unitThnxPrice &&
                                  touched.unitThnxPrice &&
                                  errors.unitThnxPrice
                                }
                                InputProps={{
                                  inputComponent: TextMaskMoney
                                }}
                              />
                            ) : (
                              undefined
                        ...
                        <div className={classes.nameContainer}>
                          <TextField
                            ...
                            onChange={handleChange}
                            onBlur={handleBlur}
                            helperText={errors.user && errors.user.firstName}
                          />
                          ...
                          <TextField
                            ...
                            onChange={handleChange}
                            onBlur={handleBlur}
                            helperText={errors.user && errors.user.lastName}
                          />
                        </div>
                        ...
                        <TextField
                          ...
                          onChange={handleChange}
                          onBlur={handleBlur}
                          helperText={errors.user && errors.user.email}
                        />
                        {!values.id || showPassword ? (
                          <div className={classes.nameContainer}>
                            <TextField
                              margin="normal"
                              required
                            ...
                            <TextField
                              ...
                              onBlur={handleBlur}
                              helperText={
                                errors.user && errors.user.passwordConfirmation
                              }
                            />
                          </div>
                        ) : (
                        ...
                        <TextField
                          ...
                          onChange={handleChange}
                          onBlur={handleBlur}
                          helperText={errors.name && errors.primaryEmail}
                        />
                        <div className={classes.nameContainer}>
                          <TextField
                            margin="normal"
                            ...
                            onBlur={handleBlur}
                            helperText={
                              errors.address1 && errors.address.address1
                            }
                          />
                          <TextField
                            margin="normal"
                            ...
                            onBlur={handleBlur}
                            helperText={
                              errors.address1 && errors.address.address2
                            }
                          />
                        </div>
                        ...
                        <div className={classes.nameContainer}>
                          <TextField
                            ...
                            onChange={handleChange}
                            onBlur={handleBlur}
                            helperText={errors.address1 && errors.address.city}
                          />
                          ...
                          <TextField
                            ...
                            onChange={handleChange}
                            onBlur={handleBlur}
                            helperText={errors.address1 && errors.address.state}
                          />
                          ...
                          <TextField
                            ...
                            onBlur={handleBlur}
                            helperText={
                              errors.address1 && errors.address.postcode
                            }
                          />
                        </div>
                        {values.id ? (
                          <div className={classes.nameContainer}>
                            <TextField
                              ...
                              onBlur={handleBlur}
                              helperText={
                                errors.address1 && errors.address.latitude
                              }
                            />
                            ...
                            <TextField
                              ...
                              onBlur={handleBlur}
                              helperText={
                                errors.address1 && errors.address.longitude
                              }
                            />
                          </div>
                        ) : (
