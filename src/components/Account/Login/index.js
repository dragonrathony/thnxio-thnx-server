            ...
            <div className={classes.root}>
              ...
              <div className={classes.mainContent}>
                <Container maxWidth="lg" className={classes.headerContainer}>
                  <div className={classes.titleContainer}>
                    ...
                    <Typography
                      ...
                      variant="h5"
                    >
                      You can add team members, top up your thnx! account and
                      monitor team performance from here
                    </Typography>
                  </div>
                ...
                <div className={classes.subtitleContainer}>
                  <Link href="https://thnx.io/corporate/" target="_blank">
                    <Typography
                      className={classes.subtitle}
                      component="h2"
                      variant="h6"
                    >
                      Learn how to activate thnx! with your team
                    </Typography>
                  </Link>
                </div>
                <div className={classes.subtitleContainer}>
                  <Link
                    href="https://hub.thnx.io/merchant/"
                    style={{ color: "white" }}
                  >
                    <Typography component="p">
                      Are you a cafe owner? Log in here
                    </Typography>
                  </Link>
                </div>
              </div>
